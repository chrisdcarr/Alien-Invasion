...
class AlienInvasion:
	...
	def _check_play_button(self,mouse_pos):
		"""start a game when the button clicks play"""
	...
	def _check_bullet_alien_collisions(self):
		...
		#check for bullets that have collided
	...
	def _create_fleet(self):
		...
		#det the num rows of aliens that fit on the screen
	...
	def _change_fleet_direction(self):
		"""drop the entire fleet and change dir"""
		for alien in self.aliens.sprites():
	...
	def _ship_hit(self):
		...
		if self.stats.ships_left > 0:
			...
			#get rid of all bullets and aliens
			self.aliens.empty()
			self.bullets.empty()
